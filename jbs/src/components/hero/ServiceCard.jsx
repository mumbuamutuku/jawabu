...
import { fin, tec, tech } from '../../assets'; // Import your assets

const ServiceCard = () => {
  return (
    <section
      id="services"
      className="bg-cover bg-center pt-32 pb-36"
      style={{ backgroundImage: "url('assets/img/services_bg.jpeg')" }}
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 dark:text-white">
          <div className="text-center md:text-left">
            <h1 className="text-3xl text-accent font-light mb-2 text-primary">Our Service List</h1>
            <h2 className="text-4xl font-semibold">We Provide Solutions To Our Clients</h2>
          </div>
          <p className="mt-4 md:mt-0 text-center md:text-left text-2xl px-10">
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          <div className="bg-white shadow-md rounded-lg p-6 transform transition-transform duration-500 hover:scale-105 border-t border-teal-500">
            <div className="flex items-center mb-4">
              <div className="bg-gray-600 p-3 rounded-md mr-4">
                <img src={tec} alt="Service Icon" className="w-8 h-8" />
              </div>
              <h2 className="text-xl font-semibold">
                <a href="human-resource" className="hover:underline">
                  FInance
                </a>
              </h2>
            </div>
            <p className="mb-4 text-gray-700">
              We specialize in developing highly effective, fully customized solutions...
            </p>
            <div className="relative rounded-lg overflow-hidden">
              <a
                href="human-resource"
                className="flex items-center justify-center bg-blue-600 text-white rounded-full w-10 h-10 absolute bottom-4 right-4"
              >
                <svg
                  width="22"
                  height="22"
              ...
              <img src={fin} alt="Service" className="w-full h-auto rounded-lg" />
            </div>
          </div>
          <div className="bg-white shadow-md rounded-lg p-6 transform transition-transform duration-500 hover:scale-105 border-t border-teal-500">
            <div className="flex items-center mb-4">
              <div className="bg-gray-100 p-3 rounded-md mr-4">
                <img src={fin} alt="Service Icon" className="w-8 h-8" />
              </div>
              <h2 className="text-xl font-semibold">
                <a href="human-resource" className="hover:underline">
                  Technology
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <img src={tech} alt="Service" className="w-full h-auto rounded-lg" />
            </div>
          </div>
          <div className="bg-white shadow-md rounded-lg p-6 transform transition-transform duration-500 hover:scale-105 border-t border-teal-500">
            <div className="flex items-center mb-4">
          ...
          {/* Repeat the above card for additional services */}
        </div>
      </div>
    </section>
  );
