      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  <img src={logo} alt="Logo" className="w-8 h-8" />
                </div>
                <span className="font-bold text-xl text-blue-600 dark:text-blue-400">Ivaden</span>
              </div>
        ...
        <section id="home" className="pt-16 min-h-screen flex items-center justify-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-blue-400/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
          </div>
          ...
          <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
            ...
            <button
              ...
              className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-200 group"
            >
              Learn More About Us
        ...
        <section id="about" className="py-20 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">About Ivaden Consultancy</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">Who We Are</h3>
        ...
        <section id="services" className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Our Core Services</h2>
        ...
        <section id="advantage" className="py-20 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Our Competitive Advantage</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-white">Why Choose Us</h3>
              <div className="grid md:grid-cols-2 gap-4">
                {advantages.map((advantage, index) => (
                  <div key={index} className="flex items-start space-x-3">
                    <CheckCircle className="w-6 h-6 text-green-500 mt-0.5 flex-shrink-0" />
                    <p className="text-gray-600 dark:text-gray-400">{advantage}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="experience" className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Selected Experience</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-6">
              {experiences.map((experience, index) => (
                <div
                  key={index}
                  className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-lg border-l-4 border-blue-500"
                >
        ...
        <section id="values" className="py-20 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Our Values</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-blue-600 dark:bg-blue-700 p-8 rounded-lg text-white text-center">
              <h3 className="text-2xl font-semibold mb-4">Why Choose Ivaden Consultancy?</h3>
              <p className="text-lg leading-relaxed max-w-4xl mx-auto">
                At Ivaden Consultancy, we don't just provide services – we build partnerships that drive lasting change. Our unique combination of technical expertise, local knowledge, and commitment to inclusion makes us the ideal partner for organizations looking to create meaningful impact in Africa's development landscape.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Let's Work Together</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">P.O. Box 373-90200, Nairobi, Kenya</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">+254 711 147 134</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">ivadenconsultancy@gmail.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
                <h3 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-white">Ready to Transform Your Impact?</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                  Whether you're a development organization, government entity, investor, or social enterprise, Ivaden Consultancy is here to help you achieve your goals.
                </p>
